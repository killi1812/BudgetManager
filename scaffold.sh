...
dotnet-ef dbcontext scaffold "Server=localhost;Database=BudgetManager;Uid=sa;Pwd=password123!;Encrypt=False;TrustServerCertificate=False" Microsoft.EntityFrameworkCore.SqlServer -o Models --force --project Data
