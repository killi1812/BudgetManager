...
dotnet-ef dbcontext scaffold "Server=localhost,1433;Database=BudgetManager;User=sa;Password=password123!;Encrypt=False;TrustServerCertificate=False" Microsoft.EntityFrameworkCore.SqlServer -o Models --force --project Data
